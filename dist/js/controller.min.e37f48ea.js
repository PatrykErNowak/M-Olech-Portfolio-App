...
var _404PageViewJs = require("./views/404PageView.js");
var _404PageViewJsDefault = parcelHelpers.interopDefault(_404PageViewJs);
var _aboutPageViewJs = require("./views/aboutPageView.js");
var _aboutPageViewJsDefault = parcelHelpers.interopDefault(_aboutPageViewJs);
var _homePageViewJs = require("./views/homePageView.js");
var _homePageViewJsDefault = parcelHelpers.interopDefault(_homePageViewJs);
var _projectsPageViewJs = require("./views/projectsPageView.js");
var _projectsPageViewJsDefault = parcelHelpers.interopDefault(_projectsPageViewJs);
 ...
 */ const urlRoutes = {
    404: (0, _404PageViewJsDefault.default),
    "/": (0, _homePageViewJsDefault.default),
    "/about": (0, _aboutPageViewJsDefault.default),
    "/projects": (0, _projectsPageViewJsDefault.default)
};
/**
...
const init = function() {
    ...
    (0, _pageViewJsDefault.default).addHandlerChangePage(controlURLRoute);
...
},{"./PageView.js":"4GbzM","../../img/icons.svg":"172kW","f992afeb4983abaa":"lMTo7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4GbzM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class PageView {
   ...
   */ _render(data) {
    ...
    _initAnimation() {
        ...
        header.h1.style.animationDelay = (0, _configJs.initAnimation).headerDelay + "ms";
        header.desc.style.animationDelay = (0, _configJs.initAnimation).descDelay + "ms";
        header.other.forEach((el)=>el.style.animationDelay = (0, _configJs.initAnimation).otherElementsDelay + "ms");
        main.style.animationDelay = (0, _configJs.initAnimation).mainContentDelay + "ms";
...
},{"3006cc1a55dbafb7":"lgJ39"}],"9rL5U":[function(require,module,exports) {
module.exports = require("40458d207ef11724").getBundleURL("hWUTQ") + "../comunicative.7c593272.webp" + "?" + Date.now();

},{"40458d207ef11724":"lgJ39"}],"24din":[function(require,module,exports) {
module.exports = require("376bb2371396d931").getBundleURL("hWUTQ") + "../reliable.801ff512.webp" + "?" + Date.now();

},{"376bb2371396d931":"lgJ39"}],"ej3ew":[function(require,module,exports) {
module.exports = require("e7e2dc1b553bf511").getBundleURL("hWUTQ") + "../experimental.b0a963d0.webp" + "?" + Date.now();

},{"e7e2dc1b553bf511":"lgJ39"}],"1ozac":[function(require,module,exports) {
module.exports = require("112b8981701dc927").getBundleURL("hWUTQ") + "../logic.1ade26f0.webp" + "?" + Date.now();

},{"112b8981701dc927":"lgJ39"}],"g8fl2":[function(require,module,exports) {
module.exports = require("fc8cd39e97413ba").getBundleURL("hWUTQ") + "../active.c56b2b34.webp" + "?" + Date.now();

},{"fc8cd39e97413ba":"lgJ39"}],"abVm0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _pageViewJs = require("./PageView.js");
var _pageViewJsDefault = parcelHelpers.interopDefault(_pageViewJs);
var _configJs = require("../config.js");
class Home extends (0, _pageViewJsDefault.default) {
    pageTitle = "Home";
    _html = `
