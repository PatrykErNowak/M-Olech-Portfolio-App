...
var _aboutPageView = require("./views/aboutPageView");
var _aboutPageViewDefault = parcelHelpers.interopDefault(_aboutPageView);
var _homePageView = require("./views/homePageView");
var _homePageViewDefault = parcelHelpers.interopDefault(_homePageView);
var _projectsPageView = require("./views/projectsPageView");
var _projectsPageViewDefault = parcelHelpers.interopDefault(_projectsPageView);
 ...
 */ const urlRoutes = {
    404: (0, _404PageViewDefault.default),
    "/": (0, _homePageViewDefault.default),
    "/about": (0, _aboutPageViewDefault.default),
    "/projects": (0, _projectsPageViewDefault.default)
};
/**
 ...
 */ const controlURLPageRender = function(isInit = false) {
    ...
    if (isInit && !isMobile) page.initRender(_model.data);
    else if (isMobile) page.render(_model.data);
    else page.animatedRender(_model.data);
};
/**
...
class PageView {
   ...
   */ render(data) {
    ...
    animatedRender(data) {
        this._parentElement.style.transition = `transform ${(0, _config.changePageAnimation).duration}ms ${(0, _config.changePageAnimation).timingFunction}`;
        this._parentElement.style.transform = "translateX(100%)";
        setTimeout(()=>{
            this.render(data);
            this._parentElement.style.transform = "translateX(0)";
        }, (0, _config.changePageAnimation).duration);
    }
    _updatePageTitle() {
    ...
    _initAnimation() {
        ...
        header.h1.style.animationDelay = (0, _config.initAnimation).headerDelay + "ms";
        header.desc.style.animationDelay = (0, _config.initAnimation).descDelay + "ms";
        header.other.forEach((el)=>el.style.animationDelay = (0, _config.initAnimation).otherElementsDelay + "ms");
        main.style.animationDelay = (0, _config.initAnimation).mainContentDelay + "ms";
...
parcelHelpers.export(exports, "swiperOptions", ()=>swiperOptions);
...
const dashboardsBoxInfoAnimation = {
    name: "fade-out-in",
    duration: 1000
};
...
var _autoplayMinCss = require("swiper/modules/autoplay.min.css");
var _paginationMinCss = require("swiper/modules/pagination.min.css");
var _a11YMinCss = require("swiper/modules/a11y.min.css");
var _pageView = require("./PageView");
var _pageViewDefault = parcelHelpers.interopDefault(_pageView);
var _config = require("../config");
class Home extends (0, _pageViewDefault.default) {
  ...
  <div class="carousel-box">
    ...
    _renderDashboards({ dashboards }) {
        ...
        actual.textContent = (0, _config.numericSystem)[0];
        ofAll.textContent = (0, _config.numericSystem)[lastDashboards.length - 1];
        // Clear swiper container
        swiperWrapper.innerHTML = "";
        //Add dashboards to swiper container
        lastDashboards.forEach((dash, i)=>{
            const { img: { src, srcMobile, alt } } = dash;
            const html = `
      <div class="swiper-slide carousel__slide">
      <div class="carousel__img-box">
      <img 
    ...
    _createSwiper({ dashboards }) {
        ...
        swiper.on("slideChange", function() {
            ...
            carouselAnimationHandle(infoTitle, (0, _config.dashboardsBoxInfoAnimation).name, (0, _config.dashboardsBoxInfoAnimation).duration);
            carouselAnimationHandle(infoDesc, (0, _config.dashboardsBoxInfoAnimation).name, (0, _config.dashboardsBoxInfoAnimation).duration);
            carouselAnimationHandle(infoBtn, (0, _config.dashboardsBoxInfoAnimation).name, (0, _config.dashboardsBoxInfoAnimation).duration);
            carouselAnimationHandle(actual, (0, _config.dashboardsBoxInfoAnimation).name, (0, _config.dashboardsBoxInfoAnimation).duration);
            setTimeout(()=>{
                ...
                actual.textContent = (0, _config.numericSystem)[currentIndex];
            }, (0, _config.dashboardsBoxInfoAnimation).duration * 0.5);
        });
    }
    _init(data) {
    ...
    dashboards: [
        {
            ...
            img: {
                src: new URL(require("aa79d17622d5369b")),
                srcMobile: new URL(require("5171cdf8f0af9c83")),
                alt: "KPI Dashboard for Northwind Traders"
            },
            themePhoto: {
                src: new URL(require("dcd0133bbcc3de5b")),
        ...
        },
        {
            ...
            img: {
                src: new URL(require("d8caefe49265c0ab")),
                srcMobile: new URL(require("b3760635f2e3a3c2")),
                alt: "Airline Passengers Satisfaction Dashboard"
            },
            themePhoto: {
                src: new URL(require("f77724054f063868")),
