  ...
  dashboards: [
    {
      ...
      img: {
        src: new URL('../img/projects/northwind-dashboard.jpg', import.meta.url),
        srcMobile: new URL('../img/projects/northwind-dashboard-mobile.jpg', import.meta.url),
    ...
    },
    {
      ...
      img: {
        src: new URL('../img/projects/airlinepassengers-dashboard.jpg', import.meta.url),
        srcMobile: new URL('../img/projects/airlinepassengers-dashboard-mobile.png', import.meta.url),
        alt: 'Airline Passengers Satisfaction Dashboard',
      },
      themePhoto: {
        src: new URL('../img/projects/airlinepassengers-photo.jpg', import.meta.url),
